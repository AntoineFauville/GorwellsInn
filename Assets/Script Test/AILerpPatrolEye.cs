...
public class AILerpPatrolEye : MonoBehaviour {
 ...
 */
    ...
    protected virtual void Start()
    {
        ...
        IA = GetComponent<Oeil>();
        pathFinding = IA.destinations;
        i = Random.Range(0, pathFinding.Length);
        target = pathFinding[i].transform.position;
    ...
    public virtual void ForceSearchPath()
    {
        ...
        var targetPosition = pathFinding[i].transform.position; // target.position
